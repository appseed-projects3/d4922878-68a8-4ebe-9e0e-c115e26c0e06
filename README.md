...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-31 15:21`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d4922878-68a8-4ebe-9e0e-c115e26c0e06.git
$ cd d4922878-68a8-4ebe-9e0e-c115e26c0e06
```
